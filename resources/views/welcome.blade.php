        ...
        <div class="col-12">
            <form id="demoForm" class="needs-validation" novalidate>
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="date" name="date" onkeyup="validateDate(this);" required>
                </div>
...
<footer>
    ...
    <script>
        function validateDate(val) {
            ...
            var validate = moment(inputDate);

            if (validate.isValid() === false || moment().max(moment()) || moment().min("1970-01-01T01:00:00+0800")) {
                alert('Wrong date');
